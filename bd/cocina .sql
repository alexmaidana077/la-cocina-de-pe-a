...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2024 a las 05:44:21
...
INSERT INTO `favoritos` (`id`, `usuarios_id`, `receta_id`) VALUES
(2, 'email@gmail.com', 6);
...
('emailss@gmail.com', '$2y$10$/AUsNMA.eaG1aN79nJU/Vek1PN8/WCXB7Wu0zSe00m8afsh8UiAdG', 'hola'),
...
(60, 'email@gmail.com', 10, 5),
(63, 'email@gmail.com', 6, 4);
...
ALTER TABLE `favoritos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `usuarios_id` (`usuarios_id`,`receta_id`);
